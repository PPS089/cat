...
export interface HealthAlert {
  ...
  status: 'attention' | 'treatment' | 'expired' | 'reminded' | string;  // 状态（后端改为 attention/treatment/reminded/expired）
...
export interface HealthAlertForm {
  ...
  status: string;                  // 状态（normal/attention/treatment/reminded/expired）
}

// 健康提醒分页结果
export type HealthAlertPageResult = PageResult<HealthAlert>
